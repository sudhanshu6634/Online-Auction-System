    ...
    <>
      <section className="my-8">
        ...
        <div className="flex flex-wrap gap-6">
          <div  className="bg-[#ffffff] w-full p-2 gap-10 rounded-md flex flex-col justify-between lg:flex-1 lg:h-auto lg:p-6 2xl:flex-none 2xl:basis-64 2xl:flex-grow 2xl:px-2  2xl:py-6">
            <span className="rounded-full bg-[#fdba88] text-black w-fit p-3">
              <RiAuctionFill />
            </span>
            <div>
              <h3 className="text-[#c57a40] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
                Auctions For
              </h3>
              <div>
                <h3 className="text-[#c57a40] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
