          ...
          <div className="flex gap-4 my-8">
            {!isAuthenticated && (
              <>
                ...
                <Link
                  to={"/login"}
                  className="text-[#cd8955] bg-transparent border-2 border-[#db8e53] hover:bg-[#fff3fd] hover:text-[#fdba88] font-bold text-xl  rounded-md px-8 flex items-center py-2 transition-all duration-300"
                >
                  Login
                </Link>
              </>
